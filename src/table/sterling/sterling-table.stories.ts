...
simpleModel.header = [
	[new TableHeaderItem({ data: 'Name Name Name Name Name Name Name Name Name Name \
	Name Name Name Name Name Name Name Name Name Name Name Name Name Name Name Name Name \
	Name Name Name Name Name Name Name Name Name Name Name Name Name Name Name Name Name \
	Name Name Name Name Name Name Name Name Name Name \
	Name', rowSpan: 2 }), new TableHeaderItem({ data: 'hwer', colSpan: 2, sortable: false }), null],
	[null, new TableHeaderItem({ data: 'hwer1' }), new TableHeaderItem({ data: 'hwer2' })]
];

simpleModel.data = [
	[new TableItem({data: 'Name 1'}), new TableItem({data: 'qwer'}), new TableItem({data: 'qwer1'})],
	[new TableItem({data: 'Name 3'}), new TableItem({data: 'zwer', colSpan: 2}), null],
	[new TableItem({data: 'Name 2'}), new TableItem({data: 'swer'}), new TableItem({data: 'swer1'})],
	[new TableItem({data: 'Name 4'}), new TableItem({data: 'twer'}), new TableItem({data: 'twer1'})]
];

storiesOf('Sterling | Sterling table', module)
	.addDecorator(
		moduleMetadata({
	...
	.add('Basic', () => ({
		...
		props: {
			...
			size: select(
				'size',
				{ Small: 'sm', Short: 'sh', Normal: 'md', Large: 'lg' },
				'md'
			),
